...
\section{Het aanzetten van meerdere ledjes in de matrix.}
...
\subsection{De matrix programmeren met behulp van de Adafruit library}
...
\begin{figure}[h!]
	\captionsetup{justification=centering}
	\includegraphics[width=0.6 \linewidth]{figuren/serial}
	\centering
